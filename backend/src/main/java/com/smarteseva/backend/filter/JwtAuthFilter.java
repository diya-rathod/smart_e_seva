// Paste the full code for JwtAuthFilter.java here
// This is a standard implementation, please adapt if your JwtService is different
package com.smarteseva.backend.filter;
